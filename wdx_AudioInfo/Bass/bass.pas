...
type
  ...
  TBASS_ChannelGetAttribute = function (handle, attrib: DWORD; var value: Single): BOOL; stdcall;

var
  BASS_Init: TBASS_Init = nil;
  BASS_Free: TBASS_Free = nil;
  BASS_MusicLoad: TBASS_MusicLoad = nil;
  BASS_MusicFree: TBASS_MusicFree = nil;
  BASS_ChannelGetTags: TBASS_ChannelGetTags = nil;
  BASS_ChannelGetLength: TBASS_ChannelGetLength = nil;
  BASS_ChannelGetAttribute: TBASS_ChannelGetAttribute = nil;
...
function BASS_LoadLibrary(FileName: string): boolean;
function BASS_FreeLibrary: boolean;
...
begin
  ...
  @BASS_MusicLoad:= GetProcAddress(hLib, 'BASS_MusicLoad');
  @BASS_ChannelGetTags:= GetProcAddress(hLib, 'BASS_ChannelGetTags');
  @BASS_ChannelGetLength:= GetProcAddress(hLib, 'BASS_ChannelGetLength');
  @BASS_ChannelGetAttribute:= GetProcAddress(hLib, 'BASS_ChannelGetAttribute');
  @BASS_MusicFree:= GetProcAddress(hLib, 'BASS_MusicFree');

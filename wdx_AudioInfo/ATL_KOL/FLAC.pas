...
type
  ...
  private
    ...
    procedure ReadTag( Source: PStream; bSetTagFields: boolean );
...
function TFLAC.GetInfo( sFile: WideString; bSetTags: boolean ): boolean;
var
  SourceFile: PStream;
...
procedure TFLAC.ReadTag( Source: PStream; bSetTagFields: boolean );
var

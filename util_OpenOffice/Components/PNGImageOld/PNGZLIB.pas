...
type
  ...
  public
    constructor Create(dest: TStream; compressionLevel: TZCompressionLevel {Paul= zcDefault{});
...
procedure ZCompress(const inBuffer: Pointer; inSize: Integer;
  ...
  level: TZCompressionLevel { Paul = zcDefault});
...
procedure ZDecompress(const inBuffer: Pointer; inSize: Integer;
 out outBuffer: Pointer; out outSize: Integer; outEstimate: Integer {Paul = 0});

{** string routines *********************************************************}

function ZCompressStr(const s: String; level: TZCompressionLevel {Paul= zcDefault}): String;

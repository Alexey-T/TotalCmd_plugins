...
type
    ...
    TMP4AtomData = object(TObj)
        ...
        function GetAsList(List: PWStrList): Boolean;
        function SetAsText(Text: String): Boolean;
        ...
        function SetAsList(List: PWStrList): Boolean;
        procedure Clear;
        function Write(MP4Stream: PStream): Boolean;
    ...
    public
        ...
        function ReadAtomData(MP4Stream: PStream; var MP4AtomData: PMP4AtomData; SkipLoadingOfDatas: Boolean): Boolean;
        function Count: Integer;
        ...
        function GetList(AtomName: TAtomName; List: PWStrList): Boolean; overload;
        function GetList(AtomName: String; List: PWStrList): Boolean; overload;
        ...
        function SetList(AtomName: TAtomName; List: PWStrList): Boolean; overload;
        function SetList(AtomName: String; List: PWStrList): Boolean; overload;
        ...
        function GetMultipleValuesMultipleAtoms(AtomName: TAtomName; List: PWStrList): Boolean; overload;
        function GetMultipleValuesMultipleAtoms(AtomName: String; List: PWStrList): Boolean; overload;
        procedure SetMultipleValuesCommaSeparated(AtomName: TAtomName; List: PWStrList); overload;
        procedure SetMultipleValuesCommaSeparated(AtomName: String; List: PWStrList); overload;
        procedure SetMultipleValuesMultipleAtoms(AtomName: TAtomName; List: PWStrList); overload;
        procedure SetMultipleValuesMultipleAtoms(AtomName: String; List: PWStrList); overload;
...
begin
    ...
    Data.Seek(4, spBegin);
    {$IFDEF FPC}
    SetLength(Result, Data.Size - 4);
    Data.Read(Result[1], Data.Size - 4);
    {$ELSE}
    SetLength(RB, Data.Size - 4);
    Data.Read(Pointer(RB)^, Data.Size - 4);
...
begin
    Result := '';
    if (DataType <> 1) or (Data.Size = 0) then begin
        Exit;
    end;
    ...
    Data.Read(Result[1], Data.Size);
    {$ELSE}
    SetLength(RB, Data.Size);
    Data.Read(Pointer(RB)^, Data.Size);
    Result := UTF8Decode(RB);
    {$ENDIF}
    Data.Seek(0, spBegin);
end;
...
function TMP4AtomData.GetAsList(List: PWStrList): Boolean;
var
    DataByte: Byte;
    Bytes: TBytes;
    Name: String;
...
function TMP4AtomData.SetAsList(List: PWStrList): Boolean;
var
    i: Integer;
    DataByte: Byte;
...
function TMP4Atom.GetAsList(List: PWStrList): Boolean;
begin
...
function TMP4Atom.SetAsList(List: PWStrList): Boolean;
begin
    if Count = 0 then begin
        AddData;
    end;
...
var aWidth, aHeight : Word;
   ...
   function ParseTrakForVideoParams: Boolean;
   begin
      Result := True;
      repeat
         if not ReadAtomHeader(MP4Stream, AtomName, AtomSize, Is64BitAtomSize) then Exit(False);
   ...
   function ParseTrakForAudioParams: Boolean;
      ...
      repeat
         ...
         begin
            repeat
               ...
               begin
                  SaveState;
                  if not ParseTrakForVideoParams then Exit; // Parse the trak for video params.
                  RestoreState;            // Restore state to parse for audio params.
                  if not ParseTrakForAudioParams then Exit; // Parse the trak for video params.
            ...
            if IsSameAtomName(AtomName, 'moov') then begin
                ...
                repeat
                    ...
                    if IsSameAtomName(AtomName, 'udta') then begin
                        ...
                        until (MP4Stream.Position >= MP4Stream.Size)
                            OR (MP4Stream.Position >= FAtomudtaPosition + FAtomudtaSize);
                ...
                until (MP4Stream.Position >= MP4Stream.Size)
                    OR (MP4Stream.Position >= FAtommoovPosition + moovAtomSize);
...
begin
    ...
    then begin
        ...
        then begin
            Exit(False);
            { Also fixed rare infinite loop in _GetIvanParameters procedure because KOL without 'err.pas' can't raise exceptions }
...
function TMP4Tag.ReadAtomData(MP4Stream: PStream; var MP4AtomData: PMP4AtomData; SkipLoadingOfDatas: Boolean): Boolean;
var
    AtomSize: DWord;
    AtomName: TAtomName;
    DataType: DWord;
...
function TMP4Tag.GetList(AtomName: TAtomName; List: PWStrList): Boolean;
var
    MP4Atom: PMP4Atom;
begin
    Result := False;
...
function TMP4Tag.GetList(AtomName: String; List: PWStrList): Boolean;
var
    AtomID: TAtomName;
begin
    StringToAtomName(AtomName, AtomID);
...
function TMP4Tag.SetList(AtomName: TAtomName; List: PWStrList): Boolean;
var
    MP4Atom: PMP4Atom;
begin
    MP4Atom := FindAtom(AtomName);
...
function TMP4Tag.SetList(AtomName: String; List: PWStrList): Boolean;
var
    AtomID: TAtomName;
begin
    StringToAtomName(AtomName, AtomID);
...
var
    MP4Tag: PMP4Tag;
begin
    if NOT WFileExists(FileName) then begin
        Result := MP4TAGLIBRARY_ERROR_OPENING_FILE;
        Exit;
    end else begin
        New(MP4Tag, Create);
...
function TMP4Tag.GetMultipleValuesMultipleAtoms(AtomName: String; List: PWStrList): Boolean;
var
    ID: TAtomName;
begin
    StringToAtomName(AtomName, ID);
...
function TMP4Tag.GetMultipleValuesMultipleAtoms(AtomName: TAtomName; List: PWStrList): Boolean;
var
    i: Integer;
begin
    List.clear;
...
procedure TMP4Tag.SetMultipleValuesCommaSeparated(AtomName: String; List: PWStrList);
var
    ID: TAtomName;
begin
    StringToAtomName(AtomName, ID);
...
procedure TMP4Tag.SetMultipleValuesCommaSeparated(AtomName: TAtomName; List: PWStrList);
var
    i: Integer;
    Text: String;
begin
...
procedure TMP4Tag.SetMultipleValuesMultipleAtoms(AtomName: String; List: PWStrList);
var
    ID: TAtomName;
begin
    StringToAtomName(AtomName, ID);
...
procedure TMP4Tag.SetMultipleValuesMultipleAtoms(AtomName: TAtomName; List: PWStrList);
var
    i: Integer;
begin
    for i := Count - 1 downto 0 do begin
